...
class Parser {
  ...
  Parser(this.tokens, this.sourceLines);
  ...
  Statement parseVarDecl() {
    ...
    return new InitialiserStmt(name, PrimitiveType.dyn(), initialiser);
  }
  ...
  Expression parseValue() {
    ...
    throw ParseException.raise(
      Issue(
        IssueType.SyntaxError,
        IssueTitle.unexpectedToken(peek()),
        lineNo: peek().lineNo,
        start: peek().start,
  ...
  Token consume(TokenType type, String expectedChar) {
    ...
    throw ParseException.raise(
      Issue(
        IssueType.SyntaxError,
        IssueTitle.unterminatedPair(expectedChar),
        lineNo: peek().lineNo,
        start: peek().start,
        offendingLine: sourceLines[peek().lineNo],
