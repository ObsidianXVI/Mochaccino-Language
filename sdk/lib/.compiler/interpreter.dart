...
class Interpreter {
  ...
  Interpreter(this.statements, this.sourceLines);
  ...
  void interpret() {
    try {
      ...
      RuntimeError runtimeError = e as RuntimeError;
      ErrorHandler.issues.add(runtimeError.issue);
      print(e.toString());
    }
  }
  ...
  void checkBooleanOperand(dynamic op, Object? operand, Token token) {
    ...
    throw RuntimeError(
      Issue(
        IssueType.TypeError,
        IssueTitle.operationTypeError(token.lexeme, bool, operand.runtimeType),
        lineNo: token.lineNo,
        start: token.start,
  ...
  void checkNumberOperand(dynamic op, Object? operand, Token token) {
    ...
    throw RuntimeError(
      Issue(
        IssueType.TypeError,
        IssueTitle.operationTypeError(
            token.lexeme, double, operand.runtimeType),
        lineNo: token.lineNo,
        start: token.start,
        offendingLine: sourceLines[token.lineNo],
        description:
